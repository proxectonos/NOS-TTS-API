...
This is a simple Text-to-speech (TTS) REST API based on the 🐸 [Col·lectivaT TTS demo server](https://github.com/CollectivaT-dev/TTS-API/tree/main).
	
## Demo

A demo app with Galician, using this systems but with another interface is available at https://tts.nos.gal. 
...
Proxecto Nos' TTS models can be found in our [Hugging Face repo](https://huggingface.co/proxectonos).
...
Preprocessors for our models are already defined in `utils/preprocessors/gl`.
